...
WEBSITE_ROOT="/Users/c.s.d.v.r.s./Developer/Control-Host/JVT-Technologies/site"
...
4. Use synthetic sample documents from:
   /Users/c.s.d.v.r.s./Developer/Control-Host/JVT-Technologies/demo-packaging/sample-documents
